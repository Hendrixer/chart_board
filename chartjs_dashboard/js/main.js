(function() {
	...
	function size(animate) {
		...
		t = setTimeout(function() {
			...
			// Kick pff the redraw function, which builds all of the charts.
			redraw(animate);
			// Loop through the widgets and find the tallest one, and set all of them to that height.
			var m = 0;
			// we have to remove any inline height setting first so that we get the auotmatic height.
			$(".widget").height("");
	...
	function redraw(animation) {
		...
		// ....
				// rest of the chart drawing here
		// ....		
	}
